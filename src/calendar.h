                                 ...
                                 public IncidenceBase::IncidenceObserver
{
  ...
  // Incidence Specific Methods //
    ...
    */
    ...
    /**
      ...
      It removes only itself. if incidence is recurring and also incidences that are dissociated
      from recurrence wanted to be deleted, deleteIncidenceInstances-function have to be called
      with incidence as a parameter.
  ...
  // Event Specific Methods //
    ...
    */
    ...
    /**
      ...
      It removes only itself. if event is recurring and also events that are dissociated
      from recurrence wanted to be deleted, deleteEventInstances-function have to be called
      with event as a parameter.
  ...
  // Todo Specific Methods //
    ...
    */
    ...
    /**
      ...
      It removes only itself. if todo is recurring and also todos that are dissociated
      from recurrence wanted to be deleted, deleteTodoInstances-function have to be called
      with todo as a parameter.
  ...
  // Journal Specific Methods //
    ...
    /**
      ...
      It removes only itself. if journal is recurring and also journals that are dissociated
      from recurrence wanted to be deleted, deleteJournalInstances-function have to be called
      with journal as a parameter.
